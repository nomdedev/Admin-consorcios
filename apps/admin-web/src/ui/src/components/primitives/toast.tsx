...
const toastVariants = cva(
  [
    ...
    "space-x-4 overflow-hidden rounded-card border p-4 shadow-lg transition-all",
  ...
  ],
  {
    variants: {
      variant: {
        ...
        success: "border-status-alDia bg-green-50 text-green-900",
        error: "border-status-grave bg-red-50 text-red-900",
        warning: "border-status-leve bg-yellow-50 text-yellow-900",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ...
    className={cn(
      ...
      "ring-offset-white transition-colors hover:bg-neutral-100",
